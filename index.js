...
output.textContent = "May the Best One Win!"
...
function playRound(){
    ...
    if (result == 0){
     output.textContent = `It's a tie! You chosed ${playerChoice}
      and your Opponent chosed ${compChoice.Value} .`;
    }
    else if (result ==1){
        output.textContent = `You won! You chosed ${playerChoice}
      and your Opponent chosed ${compChoice.Value} .`;
        playerScore++;
    }
    else if (result == 2){
        output.textContent = `You lost! You chosed ${playerChoice} 
      and your Opponent chosed ${compChoice.Value} .`;
        compScore++;
    }
}
...
function playGame(){
    ...
    if (playerScore == 5){
        output.textContent = "You Won the Deathmatch!";
        playerScore = 0;
        compScore = 0;
        player.textContent = `Player Score: ${playerScore}`;
        computer.textContent = `Computer Score: ${compScore}`;
        ...
        output.textContent = "You Lost the Deathmatch!";
        playerScore = 0;
        compScore = 0;
        player.textContent = `Player Score: ${playerScore}`;
        computer.textContent = `Computer Score: ${compScore}`;   
